...
function M.parse(arg)
    ...
    cmd:option('-gpuid',            4,                  'GPU id to use')
    ...
    -- Data
    cmd:option('-datadir',          '/home/wanglingfeng/tempory/qlw/NTIRE2017/code/data/dataset/', 'Dataset location')
    ...
    -- Training
    cmd:option('-nEpochs',          1600,                'Number of total epochs to run. 0: Infinite,300')
	...
	cmd:option('-patchSize',        48,                 'Training patch size')
    ...
    cmd:option('-chopSize',         8e4,               'Minimum chop size for chopForward')
    ...
    cmd:option('-netType',          'DenseSR-2_1',         'SR network architecture. Options: DenseSR|baseline | resnet | vdsr | msresnet')
    ...
    cmd:option('-scaleRes',         0.1,                  'Scale each residuals in residual blocks')
    ...
    cmd:option('-growthRate',        48,    'Number of output channels at each convolutional layer')
	...
	cmd:option('-depth',        16,       'ResNet depth: 18 | 34 | 50 | 101 | ...', 'number')
    cmd:option('-d1',                 4,    'Number of layers in block 1')
    cmd:option('-d2',                 4,    'Number of layers in block 2')
    cmd:option('-d3',                 4,    'Number of layers in block 3')
    cmd:option('-d4',                 4,    'Number of layers in block 4')
    -- Loss
